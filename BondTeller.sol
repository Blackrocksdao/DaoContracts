...
contract BondTeller is ITeller, BlackRocksAccessControlled {
    /* ========== DEPENDENCIES ========== */
    ...
    struct Bond {
        ...
        uint256 payout; // sBR remaining to be paid. agnostic balance
    ...
    IERC20 internal immutable BR;
    IsBR internal immutable sBR; // payment token
    ...
    function newBond(
        ...
        BR.approve(address(staking), _payout);
    ...
    function getReward() external override {
        ...
        FERs[msg.sender] = 0;
        BR.safeTransfer(msg.sender, reward);
    }
    ...
    function pay(address _bonder, uint256 _amount) internal {
        sBR.safeTransfer(_bonder, _amount);
    }
    ...
    /**
     * @notice calculate amount of BR available for claim for single bond
     * @param _bonder address
    ...
    /**
     * @notice calculate amount of BR available for claim for array of bonds
     * @param _bonder address
