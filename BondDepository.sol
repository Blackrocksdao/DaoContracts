...
contract BlackRocksBondDepository is BlackRocksAccessControlled {
  ...
  function deposit(
    ...
    require(payout >= 10000000, "Bond too small"); // must be > 0.01 BR ( underflow protection )
  ...
  /**
   * @notice calculate current ratio of debt to BR supply
   * @param _BID uint
