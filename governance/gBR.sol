...
contract gBR is IgBR, ERC20 {
    ...
    constructor(address _migrator, address _sBR)
        ERC20("Governance BR", "gBR", 18)
    {
     ...
     * @param _sBR address
     */
    function migrate(address _staking, address _sBR) external override onlyApproved {
        ...
        require(_sBR != address(0), "Zero address found");
        sBR = IsBR(_sBR);
    }
    ...
    /**
     * @notice pull index from sBR token
     */
    ...
    /**
        @notice converts gBR amount to BR
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts BR amount to gBR
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gBR::getPriorVotes: not yet determined");
